...
function initialize(threeRenderer) {
    ...
    if (!renderer.context || renderer.context.constructor != WebGL2RenderingContext) {
...
function testCode() {
    return `
breed MyBreed (x, y, dx, dy, r, g, b, a)
